...
export default function CommunicationFlows() {
  ...
  const filteredTemplates = workflowTemplates.filter(template => {
    ...
    const matchesCategory = template.tags.includes('Email') || template.tags.includes('Social Media');
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-8">
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Search Communication workflows..."
                value={searchQuery}
